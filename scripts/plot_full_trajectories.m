...
% to show only people who are completers at 5 years, uncomment these lines
%completer_5yr = ~isnan(fullfive.pain_avg_5yr);
%wh1 = wh1 & completer_5yr;
%wh2 = wh2 & completer_5yr;
%wh3 = wh3 & completer_5yr;
...
%print(gcf, fullfile(figdir, 'pain_trajectories_completers.pdf'), '-dpdf');